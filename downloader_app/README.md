...
É possível combinar dados raster com camadas shapefiles para obter imagens mais informativas. O módulo *shapefile_module* é responsável por esta parte. Primeiramente, abrimos o shapefile com geopandas e utilizamos algumas funções básicas para obter informações e visualização.
